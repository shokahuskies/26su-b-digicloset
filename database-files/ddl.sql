...
insert into General_User (user_id, username, firstName, lastName) values (41, 'rhargreaves14', 'Rosalind', 'Hargreaves');
insert into General_User (user_id, username, firstName, lastName) values (42, 'dcormack15', 'Desmond', 'Cormack');
insert into General_User (user_id, username, firstName, lastName) values (43, 'jstanhope16', 'Junia', 'Stanhope');
insert into General_User (user_id, username, firstName, lastName) values (44, 'wgalbraith17', 'Wendell', 'Galbraith');
insert into General_User (user_id, username, firstName, lastName) values (45, 'mfortescue18', 'Marisol', 'Fortescue');
insert into General_User (user_id, username, firstName, lastName) values (46, 'tholloway19', 'Torin', 'Holloway');
insert into General_User (user_id, username, firstName, lastName) values (47, 'ipennington20', 'Ilse', 'Pennington');
insert into General_User (user_id, username, firstName, lastName) values (48, 'bcastellane21', 'Barnaby', 'Castellan');
insert into General_User (user_id, username, firstName, lastName) values (49, 'ovoss22', 'Odalys', 'Voss');
insert into General_User (user_id, username, firstName, lastName) values (50, 'ksomerville23', 'Keelan', 'Somerville');
...
insert into Fashionista (fash_user, num_outfits_created) values (41, 57);
insert into Fashionista (fash_user, num_outfits_created) values (42, 71);
insert into Fashionista (fash_user, num_outfits_created) values (43, 59);
insert into Fashionista (fash_user, num_outfits_created) values (44, 57);
insert into Fashionista (fash_user, num_outfits_created) values (45, 65);
insert into Fashionista (fash_user, num_outfits_created) values (46, 75);
insert into Fashionista (fash_user, num_outfits_created) values (47, 24);
insert into Fashionista (fash_user, num_outfits_created) values (48, 23);
insert into Fashionista (fash_user, num_outfits_created) values (49, 65);
insert into Fashionista (fash_user, num_outfits_created) values (50, 60);
...
insert into Outfits (outfit_id, season, create_date, occasion, last_worn, times_worn_month, times_worn_total, user_id, fash_user) values (49, 'WINTER', '2026-05-11', 'CASUAL', '2026-07-04', 4, 12, 23, NULL);
insert into Outfits (outfit_id, season, create_date, occasion, last_worn, times_worn_month, times_worn_total, user_id, fash_user) values (50, 'FALL', '2026-08-01', 'BUSINESS CASUAL', '2026-08-01', 2, 9, 2, NULL);
insert into Outfits (outfit_id, season, create_date, occasion, last_worn, times_worn_month, times_worn_total, user_id, fash_user) values (51, 'SUMMER', '2026-05-11', 'CHIQUE', '2026-07-15', 4, 9, 4, NULL);
insert into Outfits (outfit_id, season, create_date, occasion, last_worn, times_worn_month, times_worn_total, user_id, fash_user) values (52, 'FALL', '2026-08-09', 'CASUAL', '2026-08-10', 2, 7, 37, NULL);
insert into Outfits (outfit_id, season, create_date, occasion, last_worn, times_worn_month, times_worn_total, user_id, fash_user) values (53, 'WINTER', '2026-07-13', 'ATHLETIC', '2026-07-23', 1, 8, 12, NULL);
insert into Outfits (outfit_id, season, create_date, occasion, last_worn, times_worn_month, times_worn_total, user_id, fash_user) values (54, 'SPRING', '2026-07-15', 'CHIQUE', '2026-07-20', 2, 4, 35, NULL);
insert into Outfits (outfit_id, season, create_date, occasion, last_worn, times_worn_month, times_worn_total, user_id, fash_user) values (55, 'WINTER', '2026-07-26', 'BUSINESS CASUAL', '2026-07-28', 1, 7, 3, NULL);
insert into Outfits (outfit_id, season, create_date, occasion, last_worn, times_worn_month, times_worn_total, user_id, fash_user) values (56, 'WINTER', '2026-07-13', 'ATHLETIC', NULL, 0, 0, 22, NULL);
insert into Outfits (outfit_id, season, create_date, occasion, last_worn, times_worn_month, times_worn_total, user_id, fash_user) values (57, 'SUMMER', '2026-06-17', 'ATHLETIC', '2026-08-05', 4, 12, 14, NULL);
insert into Outfits (outfit_id, season, create_date, occasion, last_worn, times_worn_month, times_worn_total, user_id, fash_user) values (58, 'WINTER', '2026-05-20', 'CASUAL', '2026-06-04', 4, 7, 22, NULL);
insert into Outfits (outfit_id, season, create_date, occasion, last_worn, times_worn_month, times_worn_total, user_id, fash_user) values (59, 'FALL', '2026-08-04', 'CASUAL', NULL, 0, 0, 11, NULL);
insert into Outfits (outfit_id, season, create_date, occasion, last_worn, times_worn_month, times_worn_total, user_id, fash_user) values (60, 'SPRING', '2026-05-05', 'CASUAL', '2026-06-24', 1, 3, 15, NULL);
...
insert into Pieces (clothing_id, outfit_id) values (43, 32);
insert into Pieces (clothing_id, outfit_id) values (55, 39);
insert into Pieces (clothing_id, outfit_id) values (30, 20);
insert into Pieces (clothing_id, outfit_id) values (41, 32);
insert into Pieces (clothing_id, outfit_id) values (45, 29);
insert into Pieces (clothing_id, outfit_id) values (9, 6);
insert into Pieces (clothing_id, outfit_id) values (49, 34);
insert into Pieces (clothing_id, outfit_id) values (40, 27);
insert into Pieces (clothing_id, outfit_id) values (23, 15);
insert into Pieces (clothing_id, outfit_id) values (44, 31);
insert into Pieces (clothing_id, outfit_id) values (24, 14);
insert into Pieces (clothing_id, outfit_id) values (9, 5);
insert into Pieces (clothing_id, outfit_id) values (25, 14);
...
insert into Closet (closet_id, fash_user, clothing_id, user_id) values (4, 12, 72, 24);
insert into Closet (closet_id, fash_user, clothing_id, user_id) values (5, 38, 39, 4);
insert into Closet (closet_id, fash_user, clothing_id, user_id) values (6, 18, 17, 10);
insert into Closet (closet_id, fash_user, clothing_id, user_id) values (7, 34, 24, 20);
insert into Closet (closet_id, fash_user, clothing_id, user_id) values (8, 14, 45, 17);
insert into Closet (closet_id, fash_user, clothing_id, user_id) values (9, 23, 9, 12);
insert into Closet (closet_id, fash_user, clothing_id, user_id) values (10, 6, 70, 31);
insert into Closet (closet_id, fash_user, clothing_id, user_id) values (11, 6, 45, 9);
insert into Closet (closet_id, fash_user, clothing_id, user_id) values (12, 26, 19, 5);
insert into Closet (closet_id, fash_user, clothing_id, user_id) values (13, 15, 42, 36);
insert into Closet (closet_id, fash_user, clothing_id, user_id) values (14, 40, 28, 5);
insert into Closet (closet_id, fash_user, clothing_id, user_id) values (15, 39, 70, 2);
insert into Closet (closet_id, fash_user, clothing_id, user_id) values (16, 40, 47, 28);
insert into Closet (closet_id, fash_user, clothing_id, user_id) values (17, 1, 39, 19);
insert into Closet (closet_id, fash_user, clothing_id, user_id) values (18, 21, 41, 38);
insert into Closet (closet_id, fash_user, clothing_id, user_id) values (19, 6, 13, 22);
insert into Closet (closet_id, fash_user, clothing_id, user_id) values (20, 20, 54, 38);
insert into Closet (closet_id, fash_user, clothing_id, user_id) values (21, 6, 56, 6);
insert into Closet (closet_id, fash_user, clothing_id, user_id) values (22, 2, 56, 13);
insert into Closet (closet_id, fash_user, clothing_id, user_id) values (23, 35, 64, 15);
insert into Closet (closet_id, fash_user, clothing_id, user_id) values (24, 2, 66, 36);
insert into Closet (closet_id, fash_user, clothing_id, user_id) values (25, 13, 57, 40);
insert into Closet (closet_id, fash_user, clothing_id, user_id) values (26, 15, 67, 3);
insert into Closet (closet_id, fash_user, clothing_id, user_id) values (27, 18, 42, 22);
insert into Closet (closet_id, fash_user, clothing_id, user_id) values (28, 24, 52, 10);
insert into Closet (closet_id, fash_user, clothing_id, user_id) values (29, 20, 28, 35);
insert into Closet (closet_id, fash_user, clothing_id, user_id) values (30, 38, 2, 21);
insert into Closet (closet_id, fash_user, clothing_id, user_id) values (31, 14, 2, 32);
insert into Closet (closet_id, fash_user, clothing_id, user_id) values (32, 5, 51, 40);
insert into Closet (closet_id, fash_user, clothing_id, user_id) values (33, 30, 58, 15);
insert into Closet (closet_id, fash_user, clothing_id, user_id) values (34, 10, 1, 32);
insert into Closet (closet_id, fash_user, clothing_id, user_id) values (35, 16, 54, 36);
insert into Closet (closet_id, fash_user, clothing_id, user_id) values (36, 25, 47, 34);
insert into Closet (closet_id, fash_user, clothing_id, user_id) values (37, 8, 26, 19);
insert into Closet (closet_id, fash_user, clothing_id, user_id) values (38, 11, 60, 25);
insert into Closet (closet_id, fash_user, clothing_id, user_id) values (39, 33, 19, 4);
insert into Closet (closet_id, fash_user, clothing_id, user_id) values (40, 31, 3, 21);
insert into Closet (closet_id, fash_user, clothing_id, user_id) values (41, 40, 28, 30);
insert into Closet (closet_id, fash_user, clothing_id, user_id) values (42, 33, 62, 34);
insert into Closet (closet_id, fash_user, clothing_id, user_id) values (43, 24, 59, 2);
insert into Closet (closet_id, fash_user, clothing_id, user_id) values (44, 3, 22, 23);
insert into Closet (closet_id, fash_user, clothing_id, user_id) values (45, 48, 17, 17);
insert into Closet (closet_id, fash_user, clothing_id, user_id) values (46, 48, 8, 11);
insert into Closet (closet_id, fash_user, clothing_id, user_id) values (47, 4, 47, 15);
insert into Closet (closet_id, fash_user, clothing_id, user_id) values (48, 29, 26, 15);
insert into Closet (closet_id, fash_user, clothing_id, user_id) values (49, 9, 18, 23);
insert into Closet (closet_id, fash_user, clothing_id, user_id) values (50, 33, 41, 33);
insert into Closet (closet_id, fash_user, clothing_id, user_id) values (51, 43, 52, 4);
insert into Closet (closet_id, fash_user, clothing_id, user_id) values (52, 22, 36, 10);
insert into Closet (closet_id, fash_user, clothing_id, user_id) values (53, 6, 71, 27);
insert into Closet (closet_id, fash_user, clothing_id, user_id) values (54, 25, 57, 16);
insert into Closet (closet_id, fash_user, clothing_id, user_id) values (55, 43, 20, 4);
...
insert into User_Profile (join_date, num_clothing, num_outfits, user_id) values ('2024-01-13', 30, 3, 26);
insert into User_Profile (join_date, num_clothing, num_outfits, user_id) values ('2024-05-24', 43, 1, 9);
insert into User_Profile (join_date, num_clothing, num_outfits, user_id) values ('2024-04-25', 34, 7, 9);
insert into User_Profile (join_date, num_clothing, num_outfits, user_id) values ('2024-05-30', 47, 1, 4);
insert into User_Profile (join_date, num_clothing, num_outfits, user_id) values ('2024-05-19', 14, 17, 29);
insert into User_Profile (join_date, num_clothing, num_outfits, user_id) values ('2025-06-22', 26, 6, 38);
insert into User_Profile (join_date, num_clothing, num_outfits, user_id) values ('2024-04-05', 7, 0, 26);
insert into User_Profile (join_date, num_clothing, num_outfits, user_id) values ('2024-12-15', 12, 6, 22);
insert into User_Profile (join_date, num_clothing, num_outfits, user_id) values ('2025-02-05', 23, 19, 16);
insert into User_Profile (join_date, num_clothing, num_outfits, user_id) values ('2024-08-03', 46, 6, 27);
...
insert into Data_Receipt (client_id, data_pack_id) values (38, 11);
insert into Data_Receipt (client_id, data_pack_id) values (18, 5);
insert into Data_Receipt (client_id, data_pack_id) values (37, 13);
insert into Data_Receipt (client_id, data_pack_id) values (11, 21);
insert into Data_Receipt (client_id, data_pack_id) values (33, 2);
insert into Data_Receipt (client_id, data_pack_id) values (26, 3);
insert into Data_Receipt (client_id, data_pack_id) values (23, 27);
insert into Data_Receipt (client_id, data_pack_id) values (5, 18);
insert into Data_Receipt (client_id, data_pack_id) values (18, 4);
insert into Data_Receipt (client_id, data_pack_id) values (8, 20);
insert into Data_Receipt (client_id, data_pack_id) values (9, 13);
insert into Data_Receipt (client_id, data_pack_id) values (23, 19);
insert into Data_Receipt (client_id, data_pack_id) values (3, 2);
insert into Data_Receipt (client_id, data_pack_id) values (12, 17);
insert into Data_Receipt (client_id, data_pack_id) values (18, 9);
insert into Data_Receipt (client_id, data_pack_id) values (12, 20);
insert into Data_Receipt (client_id, data_pack_id) values (35, 2);
insert into Data_Receipt (client_id, data_pack_id) values (2, 3);
insert into Data_Receipt (client_id, data_pack_id) values (1, 16);
insert into Data_Receipt (client_id, data_pack_id) values (40, 14);
insert into Data_Receipt (client_id, data_pack_id) values (5, 3);
insert into Data_Receipt (client_id, data_pack_id) values (31, 8);
insert into Data_Receipt (client_id, data_pack_id) values (37, 3);
insert into Data_Receipt (client_id, data_pack_id) values (14, 18);
insert into Data_Receipt (client_id, data_pack_id) values (26, 15);
insert into Data_Receipt (client_id, data_pack_id) values (13, 14);
insert into Data_Receipt (client_id, data_pack_id) values (9, 2);
insert into Data_Receipt (client_id, data_pack_id) values (22, 26);
insert into Data_Receipt (client_id, data_pack_id) values (33, 28);
insert into Data_Receipt (client_id, data_pack_id) values (38, 20);
insert into Data_Receipt (client_id, data_pack_id) values (31, 4);
insert into Data_Receipt (client_id, data_pack_id) values (20, 8);
insert into Data_Receipt (client_id, data_pack_id) values (19, 21);
insert into Data_Receipt (client_id, data_pack_id) values (4, 21);
insert into Data_Receipt (client_id, data_pack_id) values (1, 23);
insert into Data_Receipt (client_id, data_pack_id) values (9, 4);
insert into Data_Receipt (client_id, data_pack_id) values (8, 2);
insert into Data_Receipt (client_id, data_pack_id) values (40, 20);
insert into Data_Receipt (client_id, data_pack_id) values (14, 20);
insert into Data_Receipt (client_id, data_pack_id) values (1, 18);
insert into Data_Receipt (client_id, data_pack_id) values (21, 5);
insert into Data_Receipt (client_id, data_pack_id) values (26, 21);
insert into Data_Receipt (client_id, data_pack_id) values (4, 3);
insert into Data_Receipt (client_id, data_pack_id) values (35, 4);
insert into Data_Receipt (client_id, data_pack_id) values (24, 19);
insert into Data_Receipt (client_id, data_pack_id) values (4, 30);
insert into Data_Receipt (client_id, data_pack_id) values (33, 7);
insert into Data_Receipt (client_id, data_pack_id) values (3, 3);
insert into Data_Receipt (client_id, data_pack_id) values (28, 14);
insert into Data_Receipt (client_id, data_pack_id) values (5, 8);
insert into Data_Receipt (client_id, data_pack_id) values (6, 18);
insert into Data_Receipt (client_id, data_pack_id) values (28, 2);
insert into Data_Receipt (client_id, data_pack_id) values (37, 4);
insert into Data_Receipt (client_id, data_pack_id) values (15, 21);
insert into Data_Receipt (client_id, data_pack_id) values (38, 2);
insert into Data_Receipt (client_id, data_pack_id) values (37, 19);
insert into Data_Receipt (client_id, data_pack_id) values (26, 2);
insert into Data_Receipt (client_id, data_pack_id) values (15, 2);
insert into Data_Receipt (client_id, data_pack_id) values (36, 28);
insert into Data_Receipt (client_id, data_pack_id) values (9, 10);
insert into Data_Receipt (client_id, data_pack_id) values (27, 5);
insert into Data_Receipt (client_id, data_pack_id) values (37, 10);
insert into Data_Receipt (client_id, data_pack_id) values (36, 27);
insert into Data_Receipt (client_id, data_pack_id) values (12, 4);
insert into Data_Receipt (client_id, data_pack_id) values (38, 19);
insert into Data_Receipt (client_id, data_pack_id) values (13, 12);
insert into Data_Receipt (client_id, data_pack_id) values (7, 18);
insert into Data_Receipt (client_id, data_pack_id) values (5, 19);
insert into Data_Receipt (client_id, data_pack_id) values (4, 20);
insert into Data_Receipt (client_id, data_pack_id) values (14, 16);
insert into Data_Receipt (client_id, data_pack_id) values (35, 14);
insert into Data_Receipt (client_id, data_pack_id) values (21, 15);
insert into Data_Receipt (client_id, data_pack_id) values (38, 30);
insert into Data_Receipt (client_id, data_pack_id) values (30, 12);
insert into Data_Receipt (client_id, data_pack_id) values (12, 23);
insert into Data_Receipt (client_id, data_pack_id) values (16, 3);
insert into Data_Receipt (client_id, data_pack_id) values (34, 16);
insert into Data_Receipt (client_id, data_pack_id) values (22, 24);
insert into Data_Receipt (client_id, data_pack_id) values (29, 10);
insert into Data_Receipt (client_id, data_pack_id) values (39, 3);
insert into Data_Receipt (client_id, data_pack_id) values (8, 17);
insert into Data_Receipt (client_id, data_pack_id) values (27, 6);
insert into Data_Receipt (client_id, data_pack_id) values (22, 5);
insert into Data_Receipt (client_id, data_pack_id) values (32, 14);
insert into Data_Receipt (client_id, data_pack_id) values (3, 22);
insert into Data_Receipt (client_id, data_pack_id) values (5, 25);
insert into Data_Receipt (client_id, data_pack_id) values (36, 19);
insert into Data_Receipt (client_id, data_pack_id) values (21, 11);
insert into Data_Receipt (client_id, data_pack_id) values (23, 20);
insert into Data_Receipt (client_id, data_pack_id) values (32, 19);
insert into Data_Receipt (client_id, data_pack_id) values (30, 3);
insert into Data_Receipt (client_id, data_pack_id) values (6, 9);
insert into Data_Receipt (client_id, data_pack_id) values (31, 23);
insert into Data_Receipt (client_id, data_pack_id) values (5, 2);
insert into Data_Receipt (client_id, data_pack_id) values (20, 21);
insert into Data_Receipt (client_id, data_pack_id) values (37, 22);
insert into Data_Receipt (client_id, data_pack_id) values (25, 29);
insert into Data_Receipt (client_id, data_pack_id) values (23, 1);
insert into Data_Receipt (client_id, data_pack_id) values (11, 20);
insert into Data_Receipt (client_id, data_pack_id) values (8, 16);
insert into Data_Receipt (client_id, data_pack_id) values (4, 7);
insert into Data_Receipt (client_id, data_pack_id) values (19, 5);
insert into Data_Receipt (client_id, data_pack_id) values (16, 13);
insert into Data_Receipt (client_id, data_pack_id) values (26, 30);
insert into Data_Receipt (client_id, data_pack_id) values (32, 3);
insert into Data_Receipt (client_id, data_pack_id) values (11, 15);
insert into Data_Receipt (client_id, data_pack_id) values (26, 18);
insert into Data_Receipt (client_id, data_pack_id) values (18, 29);
insert into Data_Receipt (client_id, data_pack_id) values (9, 27);
insert into Data_Receipt (client_id, data_pack_id) values (28, 28);
insert into Data_Receipt (client_id, data_pack_id) values (36, 9);
insert into Data_Receipt (client_id, data_pack_id) values (27, 12);
insert into Data_Receipt (client_id, data_pack_id) values (25, 8);
insert into Data_Receipt (client_id, data_pack_id) values (10, 3);
insert into Data_Receipt (client_id, data_pack_id) values (12, 5);
insert into Data_Receipt (client_id, data_pack_id) values (15, 22);
insert into Data_Receipt (client_id, data_pack_id) values (15, 1);
insert into Data_Receipt (client_id, data_pack_id) values (32, 27);
insert into Data_Receipt (client_id, data_pack_id) values (38, 6);
insert into Data_Receipt (client_id, data_pack_id) values (17, 10);
insert into Data_Receipt (client_id, data_pack_id) values (1, 5);
insert into Data_Receipt (client_id, data_pack_id) values (27, 18);
insert into Data_Receipt (client_id, data_pack_id) values (24, 20);
insert into Data_Receipt (client_id, data_pack_id) values (37, 11);
insert into Data_Receipt (client_id, data_pack_id) values (9, 23);
insert into Data_Receipt (client_id, data_pack_id) values (33, 20);
insert into Data_Receipt (client_id, data_pack_id) values (4, 15);
insert into Data_Receipt (client_id, data_pack_id) values (36, 13);
insert into Data_Receipt (client_id, data_pack_id) values (26, 13);
insert into Data_Receipt (client_id, data_pack_id) values (26, 4);
...
insert into Issue (issue_id, category, description, status, client_id, user_id) values (161, 'OUTFITS', 'outfit recommendations seem random', 0, NULL, 25);
insert into Issue (issue_id, category, description, status, client_id, user_id) values (162, 'OTHER', 'I need help understanding a report', 1, 37, NULL);
insert into Issue (issue_id, category, description, status, client_id, user_id) values (163, 'ACCOUNT', 'my email on file is out of date', 0, 10, NULL);
insert into Issue (issue_id, category, description, status, client_id, user_id) values (164, 'APP', 'the app is unresponsive after an update', 0, 40, NULL);
insert into Issue (issue_id, category, description, status, client_id, user_id) values (165, 'OTHER', 'I have a billing question', 0, NULL, 3);
insert into Issue (issue_id, category, description, status, client_id, user_id) values (166, 'OUTFITS', 'outfit recommendations seem random', 0, 24, NULL);
insert into Issue (issue_id, category, description, status, client_id, user_id) values (167, 'OUTFITS', 'I cannot mark an outfit as worn', 0, 10, NULL);
insert into Issue (issue_id, category, description, status, client_id, user_id) values (168, 'APP', 'the app crashes on startup', 1, 40, NULL);
insert into Issue (issue_id, category, description, status, client_id, user_id) values (169, 'ACCOUNT', 'my email on file is out of date', 1, NULL, 4);
insert into Issue (issue_id, category, description, status, client_id, user_id) values (170, 'CLOSET', 'clothing categories are mislabeled', 0, 6, NULL);
insert into Issue (issue_id, category, description, status, client_id, user_id) values (171, 'OUTFITS', 'my outfit history is missing entries', 1, NULL, 15);
insert into Issue (issue_id, category, description, status, client_id, user_id) values (172, 'ACCOUNT', 'I cannot reset my password', 0, 26, NULL);
insert into Issue (issue_id, category, description, status, client_id, user_id) values (173, 'OUTFITS', 'outfit recommendations seem random', 0, NULL, 30);
insert into Issue (issue_id, category, description, status, client_id, user_id) values (174, 'CLOSET', 'I cannot remove an item from my closet', 0, NULL, 3);
insert into Issue (issue_id, category, description, status, client_id, user_id) values (175, 'ACCOUNT', 'my email on file is out of date', 1, NULL, 6);
insert into Issue (issue_id, category, description, status, client_id, user_id) values (176, 'OTHER', 'I have general feedback about the app', 0, NULL, 16);
insert into Issue (issue_id, category, description, status, client_id, user_id) values (177, 'APP', 'notifications are not showing up', 1, NULL, 27);
insert into Issue (issue_id, category, description, status, client_id, user_id) values (178, 'OUTFITS', 'my outfit history is missing entries', 1, NULL, 16);